                    ...
                    <div class="col-md-8 col-md-offset-2 col-xs-12">
                        <h3 class="title">
                            ...
                            <IntlProvider locale="en">
                                <small><i class="fa fa-clock-o"/> <FormattedRelative value={this.article.date}/></small>
                            </IntlProvider>
                            <small><a href={"mailto:" + this.article.email}> <i class="fa fa-user-circle-o"/> {this.article.author}</a>
                            </small>
